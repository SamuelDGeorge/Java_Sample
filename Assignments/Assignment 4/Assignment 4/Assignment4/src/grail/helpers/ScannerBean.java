...
import grail.tokens.QuoteMutableIterator;
...
@PropertyNames({"ScannedString", "Errors" , "Tokens"}) 
@EditablePropertyNames({"ScannedString"})

public class ScannerBean implements ArrayStore {
	...
	public WordToken generateWordClass(String input) {
		WordToken ret;
